...
// Lazy load heavy components (Vite handles file extensions automatically)
export const PremiumHeroSectionV2Lazy = lazy(() =>
  import('../../components/PremiumHeroSectionV2')
);
export const PremiumGamificationV2Lazy = lazy(() =>
  import('../../components/PremiumGamificationV2')
);
export const PremiumChartsV2Lazy = lazy(() =>
  import('../../components/PremiumChartsV2')
);
export const PremiumContinueLearningV2Lazy = lazy(() =>
  import('../../components/PremiumContinueLearningV2')
);
export const PremiumModuleAccordionV2Lazy = lazy(() =>
  import('../../components/PremiumModuleAccordionV2')
);
export const StreakHeatmapLazy = lazy(() =>
  import('../../components/StreakHeatmap')
);
export const PremiumActivityTimelineV2Lazy = lazy(() =>
  import('../../components/PremiumActivityTimelineV2')
);
export const ModuleFiltersV2Lazy = lazy(() =>
  import('../../components/ModuleFiltersV2')
);
export const LearningGoalsV2Lazy = lazy(() =>
  import('../../components/LearningGoalsV2')
);
export const PeerComparisonV2Lazy = lazy(() =>
  import('../../components/PeerComparisonV2')
);
